...
# [2] Q function as dueling network
class QNetwork:
...
# [3] Memory class for Experience Replay and Fixed Target Q-Network
class Memory:
...
# [5.2]--------------------------------------------------------
# Generate Q-Network, Memory, Actor
